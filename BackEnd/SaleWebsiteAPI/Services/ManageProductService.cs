...
using SaleWebsiteAPI.Exception;
...
namespace SaleWebsiteAPI.Services
{
    public class ManageProductService : IManageProductService
    {
        ...
        public ManageProductService(ShopDbContext shopDbContext, IStorageService storageService)
        {
        ...
        {
            // update image
            //image đã có sẵn, update cần xóa ảnh cũ và thêm thay đổi ảnh mới
